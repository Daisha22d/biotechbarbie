        ...
        <div className="flex flex-row items-start justify-center max-w-5xl mx-auto space-x-12">
          ...
          <div>
            ...
            <p className="text-lg text-gray-800 mt-4 max-w-2xl">
              As a data scientist and lifelong learner, I am currently completing my
              Masters in Data Intelligence and Machine Learning at Mercer University.
              I am passionate about transforming complex data into visually compelling
              stories, and I thrive on tackling new challenges.
            </p>
            <p className="text-lg text-gray-800 mt-4 max-w-2xl">
              Besides immersing myself in code or charts, you will find me at the gym,
            ...
            <p className="text-lg text-gray-800 mt-4 max-w-2xl">
              ...
              everything, I am constantly exploring—whether it is in data, in life, or
              anywhere in between.
            </p>
          </div>
        </div>
